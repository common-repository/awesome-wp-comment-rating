...
class AWCR_BYMO_Plugin_Settings {
    ...
    function admin_menu() {
        add_options_page( 'Awesome Comment Rating', 'Awesome Comment Rating', 'manage_options', 'awesome-wp-comment-rating', array($this, 'awcr_plugin_page') );
    }
    ...
    function awcr_plugin_page() {
        echo '<div class="wrap">';
        echo '<h1>Awesome Comment Rating</h1>';
